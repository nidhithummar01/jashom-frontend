...
export const industryItems = ['AI & Machine Learning', 'Scientific Computing', 'Data Analytics', 'Rendering & Graphics'] as const;
...
export const officeCardsData: { title: string; type: 'address' | 'email' | 'phone'; content: React.ReactNode; href?: string; subtitle?: string }[] = [
  ...
  { title: 'Phone', type: 'phone', content: '+91 90239 06363', href: 'tel:+919023906363', subtitle: 'Mon-Fri, 9AM-6PM IST' },
];
