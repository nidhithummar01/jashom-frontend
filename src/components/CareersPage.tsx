    ...
    <div className="min-h-screen" style={{ background: '#0B0F14' }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4" style={{ color: '#FAFAFA' }}>
              Why Join <span style={{ color: '#22D3EE' }}>Jashom</span>?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4 border border-[rgba(16,185,129,0.3)] bg-[rgba(16,185,129,0.1)]">
                <Briefcase className="w-8 h-8 text-[#22D3EE]" />
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: '#0B0F14' }}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4" style={{ color: '#FAFAFA' }}>
              Current <span style={{ color: '#22D3EE' }}>Openings</span>
            </h2>
                ...
                <div className="mb-8">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <span className="w-1.5 h-1.5 rounded-full mt-2 flex-shrink-0" style={{ background: '#22D3EE' }}></span>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              style={{ background: '#111827', borderColor: 'rgba(34, 211, 238, 0.3)' }}
            >
