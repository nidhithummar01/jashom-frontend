...
export const cudaDevelopmentPageData = {
  servicesData: [
  ...
  officeCardsData: [
    ...
    { title: 'Phone', type: 'phone' as const, content: '+91 90239 06363', href: 'tel:+919023906363', subtitle: 'Available Mon-Fri, 9AM-6PM IST' },
