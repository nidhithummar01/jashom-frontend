...
/** CUDA and GPU service page data in one module to avoid Sonar duplicated-lines across two files. */
const servicePagesData = {
  cuda: {
    ...
    formFieldsConfig: createServiceFormFieldsConfig('Tell us about your CUDA development needs...'),
    officeCardsData: createServiceOfficeCards('Available Mon-Fri, 9AM-6PM IST'),
  },
  ...
  gpu: {
    ...
    formFieldsConfig: createServiceFormFieldsConfig('Tell us about your GPU optimization needs...'),
    officeCardsData: createServiceOfficeCards('Mon-Fri, 9AM-6PM IST'),
  },
} as const;

export const cudaDevelopmentPageData = servicePagesData.cuda;
export const gpuOptimizationPageData = servicePagesData.gpu;
