...
export const VIOLET_COLOR = '#7C3AED';
...
const homeContactFormFields: ServiceFormField<HomeContactFieldName>[] = [
...
type HomeServiceCard = {
  ...
  href: string;
  Icon: LucideIcon;
  colorKey: 'emerald' | 'violet';
  buttonStyle: { background: string; color: string };
};

const servicesProvideData: HomeServiceCard[] = [
...
type BenefitItem = { title: string; description: string; Icon: LucideIcon };
