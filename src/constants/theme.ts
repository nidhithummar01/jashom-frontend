...
export const FORM_CONTAINER_STYLE: React.CSSProperties = { background: 'rgba(17, 24, 39, 0.6)', borderRadius: '20px', border: '1px solid rgba(255, 255, 255, 0.08)', backdropFilter: 'blur(14px)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.2)' };
...
export const FORM_MAX_WIDTH = { maxWidth: '960px', margin: '0 auto' } as const;
